            ...
            <nav className="sidebar-nav">
              ...
              <div className="nav-section">
                ...
                {canView('settings') && !isHidden('settings') && (
                  <button
                    className={currentPage === 'uom-settings' ? 'active' : ''}
                    onClick={() => setCurrentPage('uom-settings')}
                  >
                    <span className="nav-icon">📏</span>
          ...
          <main className={`main-content ${sidebarOpen ? 'sidebar-open' : ''}`}>
            ...
            <div className="page-content">
              <Suspense fallback={<LoadingSpinner />}>
                ...
                {currentPage === 'quick-item-sales' && (canView('quick-item-sales') && !isHidden('quick-item-sales') ? <QuickItemSales onNavigate={(p: any) => setCurrentPage(p as Page)} /> : <AccessDenied />)}
                ...
                {currentPage === 'returns' && customer?.isAdmin && <Returns onNavigate={(page, orderId) => { if (page === 'order-details' && orderId) setSelectedOrderId(orderId); setCurrentPage(page as Page); }} />}
